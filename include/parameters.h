#pragma once
int metalPlateMode, crystalArrayMode;
double microUnitX, microUnitY, microUnitZ, microUnitPreviousLayer;
int numPanel, numModuleT, pixelSiPM, numDetectorLayer, numDetectorinAxial;
...
double attenGAGG, attenAir, attenOpticalGlass, attenTungsten;
